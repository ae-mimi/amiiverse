    ...
    fields: [
        ...
        defineField({
            ...
            fields: [
                ...
                defineField({ name: 'accent', title: 'Accent Color', type: 'string', description: 'Hex code (e.g., #E44598)' }),
                defineField({ name: 'secondary', title: 'Secondary Accent', type: 'string', description: 'Hex code (e.g., #FCBF12)' }),
            ],
        }),
        defineField({
            name: 'favicon',
