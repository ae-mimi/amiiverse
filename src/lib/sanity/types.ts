...
export interface HeroSection extends SectionBase { _type: "hero"; title: string; subtitle?: string; description?: string; image?: SanityImage; mediaWidth?: MediaWidth; contentOrder?: ("image" | "title" | "subtitle" | "description" | "buttons")[]; cta_primary?: string; cta_primary_link?: string; cta_secondary?: string; cta_secondary_link?: string; }
export interface PredebutHeroSection extends SectionBase { _type: "predebut_hero"; top_text?: string; image?: SanityImage; mediaWidth?: MediaWidth; contentOrder?: ("topText" | "image" | "banner")[]; status_text?: string; cta_text?: string; cta_link?: string; }
...
export interface MediaTextSection extends SectionBase { _type: "media_text"; heading?: string; content?: string; image?: SanityImage; layout?: "imageLeft" | "imageRight" | "imageTop" | "imageBottom"; mediaWidth?: MediaWidth; }
export interface RichTextSection extends SectionBase { _type: "rich_text"; body?: string; }
export interface GallerySection extends SectionBase { _type: "gallery_block"; title?: string; images?: (SanityImage & { alt?: string; caption?: string })[]; columns?: number; mediaWidth?: MediaWidth; teaserLimit?: number; showGalleryLink?: boolean; galleryLinkText?: string; }
export interface LibraryGallerySection extends SectionBase { _type: "library_gallery"; title?: string; gallery?: Gallery; columns?: 2 | 3 | 4; mediaWidth?: MediaWidth; teaserLimit?: number; showGalleryLink?: boolean; galleryLinkText?: string; }
export interface VideoEmbedSection extends SectionBase { _type: "video_embed"; title?: string; video_url: string; caption?: string; }
export interface CtaBannerSection extends SectionBase { _type: "cta_banner"; heading: string; description?: string; button_text: string; button_link: string; bg_image?: SanityImage; mediaWidth?: MediaWidth; }
